 ...
 */ var b = {
    ...
    return t(n, e), n;
}(Error), E = "7.21.1-2020822235757", _ = new o("@firebase/firestore");
...
function N(t) {
    ...
    if (_.logLevel <= s.DEBUG) {
        var i = e.map(D);
        _.debug.apply(_, r([ "Firestore (" + E + "): " + t ], i));
    }
}

function A(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (_.logLevel <= s.ERROR) {
        var i = e.map(D);
        _.error.apply(_, r([ "Firestore (" + E + "): " + t ], i));
    }
}

function S(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (_.logLevel <= s.WARN) {
        var i = e.map(D);
        _.warn.apply(_, r([ "Firestore (" + E + "): " + t ], i));
    }
}
...
}(P), C = /^[_a-zA-Z][_a-zA-Z0-9]*$/, M = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.o = function(t, e, r) {
 ...
 */ function H(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new I(b.INVALID_ARGUMENT, "Invalid value " + J(r) + " provided to function " + t + "() for its " + rt(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function $(t, e, n, r) {
 ...
 */ var dt = /** @class */ function(e) {
    ...
    return t(n, e), n.fromBase64String = function(t) {
        G("Blob.fromBase64String", arguments, 1), z("Blob.fromBase64String", "string", 1, t), 
        pt();
        try {
        ...
        if (G("Blob.fromUint8Array", arguments, 1), lt(), !(t instanceof Uint8Array)) throw et("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new n(ht.fromUint8Array(t));
    }, n.prototype.toBase64 = function() {
        return G("Blob.toBase64", arguments, 0), pt(), e.prototype.toBase64.call(this);
    }, n.prototype.toUint8Array = function() {
        return G("Blob.toUint8Array", arguments, 0), lt(), e.prototype.toUint8Array.call(this);
    }, n.prototype.toString = function() {
...
function Nt(t) {
    ...
    if (null === e.Z) {
        ...
        n += mr(e.startAt)), e.endAt && (n += "|ub:", n += mr(e.endAt)), e.Z = n;
    }
    return e.Z;
}
...
function At(t, e) {
    ...
    var i, o;
    return t.collectionGroup === e.collectionGroup && !!t.path.isEqual(e.path) && !!wr(t.startAt, e.startAt) && wr(t.endAt, e.endAt);
}
 ...
 */ function Lt(t) {
    ...
    return A("GRPC error has no .code"), b.UNKNOWN;
    switch (t) {
      case Dt.OK:
        return b.OK;
...
var Ut = /** @class */ function() {
    ...
    t.prototype.Ct = function() {
        if (this.gt() && this.left.gt()) throw x();
        if (this.right.gt()) throw x();
        var t = this.left.Ct();
...
var Ct = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.$t = function(t) {
        ...
        return new Mt(this.data.lt());
    }, t.prototype._t = function(t) {
        return new Mt(this.data._t(t));
    }, 
...
var zt = new Ut(F.i), Qt = new Ct(F.i);
 ...
 */ var Ht = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Mt = jt(), this.Ot = new Ut(this.i)
        /**
    ...
    return t.Kt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Wt === t.Wt && this.Qt.isEqual(t.Qt) && nr(this.query, t.query) && this.docs.isEqual(t.docs) && this.Ut.isEqual(t.Ut))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Zt.Xt(e, n)), new t(wt.min(), r, Yt(), qt(), Kt());
    }, t;
}(), Zt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.pe = function(t) {
        for (var e = 0, n = t.se; e < n.length; e++) {
            var r = n[e];
            t.ie instanceof qn ? this.be(r, t.ie) : t.ie instanceof Gn && this.ve(r, t.key, t.ie);
        }
    ...
    t.prototype.Me = function(t) {
        ...
        this.Pe.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Zt && St(o.target)) {
                    ...
                    null !== e.ge.get(s) || e.Oe(i, s) || e.ve(i, s, new Gn(s, t));
                }
        ...
        var i = new Jt(t, n, this.Ve, this.ge, r);
        return this.ge = qt(), this.ye = oe(), this.Ve = new Ct(ut), i;
    }, 
    /**
    ...
    t.prototype.Ee = function(t) {
        ...
        var e = this.Pe.get(t);
        return e || (e = new re, this.Pe.set(t, e)), e;
    }, t.prototype.Le = function(t) {
        var e = this.ye.get(t);
        return e || (e = new Ct(ut), this.ye = this.ye.rt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Fe = function(t) {
        var e = this;
        this.Pe.set(t, new re), this.Re.Be(t).forEach((function(n) {
...
/** Extracts the backend's type order for the provided value. */ function he(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? ue(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : x();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function fe(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return at(t.arrayValue.values || [], e.arrayValue.values || [], fe);
...
function pe(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ut(me(t.latitude), me(e.latitude));
            return 0 !== n ? n : ut(me(t.longitude), me(e.longitude));
...
function de(t, e) {
    ...
    var n = ye(t), r = ye(e), i = ut(n.seconds, r.seconds);
...
function ve(t) {
    return function t(e) {
        ...
        }(e.timestampValue) : "stringValue" in e ? e.stringValue : "bytesValue" in e ? ge(e.bytesValue).toBase64() : "referenceValue" in e ? (r = e.referenceValue, 
        F.C(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function Qe(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? bn.updateTime(Ue(t.updateTime)) : void 0 !== t.exists ? bn.exists(t.exists) : bn.Ge();
    }(e.currentDocument) : bn.Ge();
    if (e.update) {
        e.update.name;
        var r = Me(t, e.update.name), i = new Vn({
            mapValue: {
        ...
        if (e.updateMask) {
            var o = function(t) {
                var e = t.fieldPaths || [];
                return new mn(e.map((function(t) {
                    return M.S(t);
                })));
            }(e.updateMask);
            return new xn(r, i, o, n);
        }
        return new Dn(r, i, n);
    }
    if (e.delete) {
    ...
    if (e.transform) {
        var u = Me(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                var n = null;
                if ("setToServerValue" in e) k("REQUEST_TIME" === e.setToServerValue), n = new cn; else if ("appendMissingElements" in e) {
                    var r = e.appendMissingElements.values || [];
                    n = new hn(r);
                } else if ("removeAllFromArray" in e) {
                    var i = e.removeAllFromArray.values || [];
                    n = new ln(i);
                } else "increment" in e ? n = new dn(t, e.increment) : x();
                var o = M.S(e.fieldPath);
                return new gn(o, n);
            }(t, e);
        }));
        return k(!0 === n.exists), new On(u, a);
    }
    if (e.verify) {
        var c = Me(t, e.verify);
        return new Pn(c, n);
...
function We(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Fe(t, r), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = Fe(t, r.h()), n.structuredQuery.from = [ {
        collectionId: r._()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Ye(e.startAt)), 
...
function tn(t) {
    return ur.create(Ze(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function en(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        ...
        return ur.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Ze(t.unaryFilter.field);
        return ur.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Ze(t.unaryFilter.field);
        return ur.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Ze(t.unaryFilter.field);
        return ur.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function sn(t, e, n) {
    return t instanceof cn ? function(t, e) {
        ...
        var n = an(t, e), r = vn(n) + vn(t.We);
        return be(n) && be(t.We) ? De(r) : xe(t.serializer, r);
    }(t, e);
}
 ...
 */ function _n(t, e, n) {
    return t instanceof Dn ? function(t, e, n) {
        ...
        if (k(null != n.transformResults), !In(t.Ke, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                e instanceof qn && (u = e.field(o.field)), r.push(un(s, u, n[i]));
            }
            return r;
 ...
 */ function Tn(t, e, n, r) {
    return t instanceof Dn ? function(t, e) {
        ...
        if (!In(t.Ke, e)) return e;
        var i = Rn(t, e), o = function(t, e, n, r) {
        ...
        return In(t.Ke, e) ? new Gn(t.key, wt.min()) : e;
    }(t, e);
}
 ...
 */ function Nn(t, e) {
    return t instanceof On ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof qn ? e.field(o.field) : void 0, u = an(o.transform, s || null);
            null != u && (n = null == n ? (new Cn).set(o.field, u) : n.set(o.field, u));
        }
        return n ? n.Je() : null;
    }(t, e) : null;
}
    ...
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ke.isEqual(e.Ke) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Qe.isEqual(e.Qe) : 2 /* Transform */ !== t.type || at(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof hn && e instanceof hn || t instanceof ln && e instanceof ln ? at(t.elements, e.elements, fe) : t instanceof dn && e instanceof dn ? fe(t.We, e.We) : t instanceof cn && e instanceof cn;
...
function kn(t, e) {
    ...
    }(t, e instanceof qn ? e.data() : Vn.empty());
}
...
function Ln(t, e, n) {
    for (var r = new Cn(e), i = 0; i < t.fieldTransforms.length; i++) {
...
/** A mutation that deletes the document at the given key. */ var Un = /** @class */ function(e) {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.Je = function() {
        var t = this.en(M.g(), this.Ze);
        return null != t ? new Vn(t) : this.Xe;
    }, 
    /**
 ...
 */
/** Creates a new Query instance with the options provided. */ function zn(t, e, n, r, i, o, s, u) {
    return new jn(t, e, n, r, i, o, s, u);
}
 ...
 * paths.
 */ function Kn(t) {
    return !bt(t.limit) && "F" /* First */ === t.on;
}

function Wn(t) {
    return !bt(t.limit) && "L" /* Last */ === t.on;
}
 ...
 */ function Xn(t) {
    ...
    if (null === e.an) {
        ...
        n.p() || e.an.push(new br(n)), e.an.push(new br(M.v(), "asc" /* ASCENDING */)); else {
 ...
 */ function Jn(t) {
    ...
    if (!e.cn) if ("F" /* First */ === e.on) e.cn = Tt(e.path, e.collectionGroup, Xn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        var n = [], r = 0, i = Xn(e); r < i.length; r++) {
            ...
            n.push(new br(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new yr(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new yr(e.startAt.position, !e.startAt.before) : null;
...
function tr(t, e) {
    return new jn(t.path, t.collectionGroup, t.rn.slice(), t.filters.slice(), t.limit, t.on, e, t.endAt);
}

function er(t, e) {
    return new jn(t.path, t.collectionGroup, t.rn.slice(), t.filters.slice(), t.limit, t.on, t.startAt, e);
}
...
function ir(t) {
    return "Query(target=" + function(t) {
        ...
        bt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.R() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + mr(t.startAt)), t.endAt && (e += ", endAt: " + mr(t.endAt)), 
        "Target(" + e + ")";
    }(Jn(t)) + "; limitType=" + t.on + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function or(t, e) {
    return function(t, e) {
        ...
        return !(t.startAt && !gr(t.startAt, Xn(t), e)) && (!t.endAt || !gr(t.endAt, Xn(t), e));
    }(t, e);
}
...
var ur = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.p()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.hn(t, e, r) : new ar(t, e, r);
        if (Ee(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new lr(t, r) : "in" /* IN */ === e ? new pr(t, r) : "not-in" /* NOT_IN */ === e ? new dr(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new vr(t, r) : new n(t, e, r);
    }, n.hn = function(t, e, n) {
        return "in" /* IN */ === e ? new cr(t, n) : new hr(t, n);
...
var ar = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = fr("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(ur), hr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = fr("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function fr(t, e) {
    var n;
...
/** A Filter that implements the array-contains operator. */ var lr = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Ie(e) && le(e.arrayValue, this.value);
    }, n;
}(ur), pr = /** @class */ function(e) {
    function n(t, n) {
...
/** A Filter that implements the IN operator. */ function mr(t) {
 ...
 */ var _r = function() {
    ...
    t.prototype.Rn = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && N("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Tn + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Sn && x(), this.Sn = !0, this.vn ? this.error ? this.Dn(n, this.error) : this.Cn(e, this.result) : new t((function(t, i) {
            r.pn = function(n) {
                r.Cn(e, n).next(t, i);
            }, r.bn = function(e) {
                r.Dn(n, e).next(t, i);
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.Mn(u()) && A("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return N("SimpleDb", "Removing database:", t), Rr(window.indexedDB.deleteDatabase(t)).Nn();
    }, 
                  ...
                  case 0:
                    ...
                    t = this, [ 4 /*yield*/ , new Promise((function(t, n) {
                        ...
                        r.onsuccess = function(e) {
                            ...
                            N("SimpleDb", 'Database "' + e.name + '" requires upgrade from version:', t.oldVersion);
                            var n = t.target.result;
                            e.kn.createOrUpgrade(n, r.transaction, t.oldVersion, e.version).next((function() {
                                N("SimpleDb", "Database upgrade to version " + e.version + " complete");
                            }));
                        };
                    })) ]);
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return u.db = n.sent(), t = kr.open(u.db, e ? "readonly" : "readwrite", r), s = i(t).catch((function(e) {
                                    // Abort the transaction if there was an error.
                                    return t.abort(e), Nr.reject(e);
                              ...
                              case 4:
                                return c = n.sent(), h = "FirebaseError" !== c.name && o < 3, N("SimpleDb", "Transaction failed with error:", c.message, "Retrying:", h), 
 ...
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function xr(t) {
 ...
 */ var kr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Xn = new _r, this.transaction.oncomplete = function() {
            e.Xn.resolve();
    ...
    return t.open = function(e, n, r) {
        ...
        t && this.Xn.reject(t), this.aborted || (N("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    t.prototype.add = function(t) {
        return N("SimpleDb", "ADD", this.store.name, t, t), Rr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Rr(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), N("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return N("SimpleDb", "DELETE", this.store.name, t), Rr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return N("SimpleDb", "COUNT", this.store.name), Rr(this.store.count());
 ...
 */ var Cr = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.os = t, this.fn = e, this.cs = n, this.op = r, this.us = i, this.hs = new _r, 
    ...
    function t() {
        ...
        this.ys = function() {
            var e = Vr();
            e && N("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.gs.yn();
        };
        var e = Vr();
    ...
    t.prototype.Cs = function() {
        ...
        var e = this, n = this.ws.then((function() {
            return e.Rs = !0, t().catch((function(t) {
                ...
                throw e.As = t, e.Rs = !1, A("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.gn = function(t, e, n) {
        ...
        var i = Cr.ls(this, t, e, n, (function(t) {
            return r.Ns(t);
        }));
 ...
 */
function Fr(t, e) {
    if (A("AsyncQueue", e + ": " + t), xr(t)) return new I(b.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var qr = function() {
    ...
    this.Ls = new mt((function(t) {
        return rr(t);
    }), nr), this.onlineState = "Unknown" /* Unknown */ , this.Bs = new Set;
};
...
function Br(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = O(t), i = r.query, o = !1, (s = e.Ls.get(i)) || (o = !0, s = new qr), !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
              ...
              case 3:
                return a = n.sent(), c = Fr(a, "Initialization of query '" + ir(r.query) + "' failed"), 
                [ 2 /*return*/ , void r.onError(c) ];

              case 4:
                return e.Ls.set(i, s), s.listeners.push(r), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                r.Us(e.onlineState), s.Os && r.Qs(s.Os) && Kr(e), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function jr(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o, s, u;
        return n(this, (function(n) {
            return e = O(t), i = r.query, o = !1, (s = e.Ls.get(i)) && (u = s.listeners.indexOf(r)) >= 0 && (s.listeners.splice(u, 1), 
...
Yr.ti = new Yr("google-credentials-uid"), Yr.ei = new Yr("first-party-uid");
...
var Zr = /** @class */ function() {
    ...
    return t.ai = function(e, n, r) {
        ...
        o ? new t(e, n, i.state, s) : (A("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.ai = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Yt(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Et(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.fi = null, this.ni = null, this.di = this.wi.bind(this), this.mi = new Ut(ut), 
        this.Ti = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Ii = $r(this.persistenceKey, this.li), 
        this.Ai = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.mi = this.mi.rt(this.li, new ri), this.Ri = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.On = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.li && (o = this.getItem($r(this.persistenceKey, i))) && (s = ei.ai(i, o)) && (this.mi = this.mi.rt(s.clientId, s));
        ...
        // `Window.addEventListener`.
            ...
            if (N("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Ii) return void A("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this._n.Ds((function() {
        ...
        var r = new Zr(this.currentUser, t, e, n), i = Xr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.ci());
        ...
        var r = Jr(this.persistenceKey, t), i = new ti(t, e, n);
        this.setItem(r, i.ci());
    }, 
    /**
    ...
    t.prototype.bi = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this._i.tr(t.batchId, t.state, t.error) ] : (N("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    function t() {
        this.sr = new ri, this.ir = {}, this.fi = null, this.ni = null;
    }
    return t.prototype.Fi = function(t) {
        ...
        return this.sr = new ri, Promise.resolve();
    }, t.prototype.Wi = function(t, e, n) {
        // No op.
    }, t.prototype.ji = function(t) {
        // No op.
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = zt, o = e.mutations, s = 0; s < o.length; s++) i = i.rt(o[s].key, r[s].version);
    ...
    t.prototype.Ar = function(t, e) {
        this.Er();
        var n = this.dr.get(e);
        return void 0 !== n ? Nr.resolve(n) : this.Rr(t, e);
    }, 
    /**
    ...
    t;
}(), ci = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", hi = /** @class */ function() {
    function t() {
        this.yr = [];
    }
    ...
    t.prototype.kr = function(t, e) {
        ...
        return this.vr.Mr(t, e).next((function(r) {
            var i = n.Fr(t, e, r), o = qt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Gn(t, wt.min())), o = o.rt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return F.F(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Lr(t, e.path) : $n(e) ? this.Br(t, e, n) : this.qr(t, e, n);
    }, t.prototype.Lr = function(t, e) {
        // Just do a simple document lookup.
        return this.Dr(t, new F(e)).next((function(t) {
            var e = jt();
        ...
        for (var r = Kt(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof xn && null === n.get(a.key) && (r = r.add(a.key));
        }
        var c = n;
 ...
 */ var di = /** @class */ function() {
    function t(t) {
        this.zr = t, this.buffer = new Ct(pi), this.Hr = 0;
    }
...
var mi = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        N("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.mo = this.os.gn("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return xr(e = n.sent()) ? (N("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Po = function(t, e) {
        var n = this;
        if (0 === e) return Nr.resolve(Hr.oi);
        var r = new di(e);
    ...
    t.prototype.po = function(t, e) {
        ...
        var n = this;
        return this.params.so === yi.uo ? (N("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Nr.resolve(vi)) : this.vo(t).next((function(r) {
            return r < n.params.so ? (N("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.so), 
            vi) : n.So(t, e);
        }));
        ...
        return this.Ao(t, this.params.io).next((function(e) {
            ...
            return e > h.params.ro ? (N("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.params.ro + " from " + e), 
            ...
            return c = Date.now(), T() <= s.DEBUG && N("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), 
            Nr.resolve({
                Xr: !0,
                Zr: r,
                eo: i,
...
/** Decodes a remote document from storage locally to a Document. */ function Ti(t, e) {
    ...
    if (e.noDocument) {
        var n = F.$(e.noDocument.path), r = xi(e.noDocument.readTime);
        return new Gn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = F.$(e.unknownDocument.path), o = xi(e.unknownDocument.version);
        return new Bn(i, o);
    }
    return x();
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function ki(t, e) {
    var n = (e.baseMutations || []).map((function(e) {
        return Qe(t.Do, e);
    })), r = e.mutations.map((function(e) {
        return Qe(t.Do, e);
    })), i = gt.fromMillis(e.localWriteTimeMs);
    return new si(e.batchId, i, n, r);
}

/** Decodes a DbTarget into TargetData */ function Oi(t) {
    var e, n, r = xi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? xi(t.lastLimboFreeSnapshotVersion) : wt.min();
    return void 0 !== t.query.documents ? (k(1 === (n = t.query).documents.length), 
    e = Jn(Qn(qe(n.documents[0])))) : e = function(t) {
        var e = qe(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
        if (r > 0) {
            k(1 === r);
            var o = n.from[0];
        ...
        n.where && (s = function t(e) {
            return e ? void 0 !== e.unaryFilter ? [ en(e) ] : void 0 !== e.fieldFilter ? [ tn(e) ] : void 0 !== e.compositeFilter ? e.compositeFilter.filters.map((function(e) {
                return t(e);
            })).reduce((function(t, e) {
                return t.concat(e);
            })) : x() : [];
        ...
        var h = null;
        return n.endAt && (h = He(n.endAt)), Jn(zn(e, i, u, s, a, "F" /* First */ , c, h));
...
function Ri(t, e) {
    ...
    n = St(e.target) ? Ke(t.Do, e.target) : We(t.Do, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new no(e.targetId, Nt(e.target), r, o, e.sequenceNumber, i, n);
}
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Li = /** @class */ function() {
    ...
    return t.Fo = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            k("number" == typeof u);
            for (var a = new si(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return ze(t.Do, e);
                })), i = n.mutations.map((function(e) {
                    return ze(t.Do, e);
                }));
                return new $i(e, n.batchId, n.rr.toMillis(), r, i);
            }(i.serializer, i.userId, a), h = [], f = new Ct((function(t, e) {
                return ut(t.R(), e.R());
        ...
        return Vi(t).get(e).next((function(t) {
            return t ? (k(t.userId === n.userId), ki(n.serializer, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Oo = function(t, e) {
        var n = this;
        return this.No[e] ? Nr.resolve(this.No[e]) : this.Mo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.No[e] = r, r;
            }
        ...
        return Vi(t).ss({
            ...
            e.userId === n.userId && (k(e.batchId >= r), o = ki(n.serializer, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Vi(t).Zn($i.userMutationsIndex, n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return Vi(t).get(c).next((function(t) {
                if (!t) throw x();
                k(t.userId === n.userId), o.push(ki(n.serializer, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Ct(ut), i = [];
        return e.forEach((function(e) {
            var o = Xi.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Ci(t).ss({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = Ei(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), Nr.$n(i).next((function() {
            return n.Uo(t, r);
        }));
    }, t.prototype.Qr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Xi.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Ct(ut);
        return Ci(t).ss({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = Ei(a);
            s === n.userId && r.T(h) ? 
        ...
        return e.forEach((function(e) {
            i.push(Vi(t).get(e).next((function(t) {
                if (null === t) throw x();
                k(t.userId === n.userId), r.push(ki(n.serializer, t));
            })));
        })), Nr.$n(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Pi(t.Wo, this.userId, e).next((function(r) {
            return t.Vr((function() {
                n.jo(e.batchId);
            })), Nr.forEach(r, (function(e) {
                return n.Co.Ko(t, e);
            }));
        }));
    }, 
 ...
 */ function Pi(t, e, n) {
    var r = t.store($i.store), i = t.store(Xi.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.ss({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
 ...
 */ function Vi(t) {
    return wo.Un(t, $i.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ci(t) {
    return wo.Un(t, Xi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Mi(t) {
    return wo.Un(t, Hi.store);
}
 ...
 */ var Fi = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Gi(t).get(Bi(e)).next((function(t) {
            return n.Jo(t);
        }));
    }, 
    /**
    ...
    t.prototype.ea = function(t, e) {
        var n = this, r = Gt(), i = new Ut(F.i);
        return this.ta(t, e, (function(t, e) {
            var o = n.Jo(e);
            o ? (r = r.rt(t, o), i = i.rt(t, ji(e))) : (r = r.rt(t, null), i = i.rt(t, 0));
        })).next((function() {
            return {
                na: r,
                sa: i
        ...
        if (n.isEqual(wt.min())) {
            ...
            var a = e.path.A(), c = Ai(n);
            s.range = IDBKeyRange.lowerBound([ a, c ], 
            /* open= */ !0), s.index = to.collectionReadTimeIndex;
        }
        return Gi(t).ss(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.T(u.key.path) ? u instanceof qn && or(e, u) && (i = i.rt(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.ia = function(t, e) {
        var n = this, r = qt(), i = Ai(e), o = Gi(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.ss({
            index: to.readTimeIndex,
            range: s
        }, (function(t, e) {
    ...
    t.prototype.oa = function(t) {
        ...
        return qi(t).get(eo.key).next((function(t) {
            return k(!!t), t;
        }));
    }, t.prototype.Yo = function(t, e) {
        return qi(t).put(eo.key, e);
    }, 
    /**
 ...
 */ function qi(t) {
    return wo.Un(t, eo.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Gi(t) {
    return wo.Un(t, to.store);
}
 ...
 */ Fi.ca = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.gr = function(t) {
        var e = this, n = [], r = 0, i = new Ct((function(t, e) {
            return ut(t.R(), e.R());
        }));
        return this.dr.forEach((function(o, s) {
            var u = e._a.get(o);
            if (s) {
                var a = Ni(e.la.serializer, s, e.readTime);
                i = i.add(o.path.h());
                var c = ji(a);
                ...
                var h = Ni(e.la.serializer, new Gn(o, wt.min()), e.readTime);
                n.push(e.la.Tr(t, o, h));
            } else n.push(e.la.Ir(t, o));
        })), i.forEach((function(r) {
            n.push(e.la.Sr.ko(t, r));
        })), n.push(this.la.updateMetadata(t, r)), Nr.$n(n);
...
var zi = /** @class */ function() {
    ...
    return t.prototype.ko = function(t, e) {
        return this.fa.add(e), Nr.resolve();
    }, t.prototype.Ur = function(t, e) {
        return Nr.resolve(this.fa.getEntries(e));
    }, t;
}(), Qi = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t._(), n = t.h(), r = this.index[e] || new Ct(V.i), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t._(), n = t.h(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Ct(V.i)).A();
    }, t;
}(), Ki = /** @class */ function() {
    function t(t) {
        this.serializer = t;
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(Hi.store, {
                ...
                keyPath: $i.keyPath,
                autoIncrement: !0
            }).createIndex($i.userMutationsIndex, $i.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(ro.store), t.deleteObjectStore(no.store), t.deleteObjectStore(io.store);
        }(t), so(t)), s = s.next((function() {
            /**
     ...
     */
            return function(t) {
                var e = t.store(io.store), n = new io(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, wt.min().X(), 
                /*targetCount=*/ 0);
                return e.put(io.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store($i.store).Zn().next((function(n) {
                    t.deleteObjectStore($i.store), t.createObjectStore($i.store, {
                        keyPath: $i.keyPath,
                        autoIncrement: !0
                    }).createIndex($i.userMutationsIndex, $i.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store($i.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return Nr.$n(i);
                }));
            ...
            !function(t) {
                ...
                var e = t.objectStore(to.store);
                e.createIndex(to.readTimeIndex, to.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(to.collectionReadTimeIndex, to.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(to.store).ss((function(t, n) {
            e += ji(n);
        })).next((function() {
            var n = new eo(e);
            return t.store(eo.store).put(eo.key, n);
        }));
    }, t.prototype.removeAcknowledgedMutations = function(t) {
        var e = this, n = t.store(Hi.store), r = t.store($i.store);
        return n.Zn().next((function(n) {
            return Nr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Zn($i.userMutationsIndex, i).next((function(r) {
                    return Nr.forEach(r, (function(r) {
                        k(r.userId === n.userId);
                        var i = ki(e.serializer, r);
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(ro.store), n = t.store(to.store);
        return t.store(io.store).get(io.key).next((function(t) {
            var r = [];
            return n.ss((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? Nr.resolve() : function(n) {
                        return e.put(new ro(0, wi(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Nr.$n(r);
        ...
        var n = e.store(oo.store), r = new Qi, i = function(t) {
            if (r.add(t)) {
                var e = t._(), i = t.h();
                return n.put({
                    collectionId: e,
        ...
        var e = this, n = t.store(no.store);
        return n.ss((function(t, r) {
            var i = Oi(r), o = Ri(e.serializer, i);
            return n.put(o);
        }));
    }, t;
}(), Wi = function(t, e) {
...
/** Name of the IndexedDb object store.  */ $i.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
$i.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
$i.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
$i.userMutationsKeyPath = [ "userId", "batchId" ];
...
/**
     ...
     */
to.readTimeIndex = "readTimeIndex", to.readTimeIndexPath = "readTime", 
/**
     ...
     */
to.collectionReadTimeIndex = "collectionReadTimeIndex", to.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
eo.store = "remoteDocumentGlobal", eo.key = "remoteDocumentGlobalKey";
...
no.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
no.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ ro.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
ro.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
ro.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
ro.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ io.key = "targetGlobalKey", io.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ function so(t) {
    t.createObjectStore(ro.store, {
        keyPath: ro.keyPath
    }).createIndex(ro.documentTargetsIndex, ro.documentTargetsKeyPath, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(no.store, {
        keyPath: no.keyPath
    }).createIndex(no.queryTargetsIndexName, no.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(io.store);
}

oo.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
oo.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ uo.store = "clientMetadata", 
/** Keys are automatically assigned via the clientId properties. */
uo.keyPath = "clientId";

var ao = r(r(r([ Hi.store, $i.store, Xi.store, to.store, no.store, Yi.store, io.store, ro.store ], [ uo.store ]), [ eo.store ]), [ oo.store ]), co = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.ko = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return ho(t).Zn(r).next((function(t) {
 ...
 */ var fo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Ia(t).next((function(n) {
            var r = new fo(n.highestTargetId);
        ...
        return this.Ia(t).next((function(t) {
            return wt.Y(new gt(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.Sa(t, e.targetId).next((function() {
            return po(t).delete(e.targetId);
        })).next((function() {
            return n.Ia(t);
        })).next((function(e) {
            return k(e.targetCount > 0), e.targetCount -= 1, n.Aa(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.De = function(t, e) {
        return po(t).ss((function(t, n) {
            var r = Oi(n);
            e(r);
        }));
    }, t.prototype.Ia = function(t) {
        return vo(t).get(io.key).next((function(t) {
            return k(null !== t), t;
        }));
    }, t.prototype.Aa = function(t, e) {
        return vo(t).put(io.key, e);
    }, t.prototype.Va = function(t, e) {
        return po(t).put(Ri(this.serializer, e));
    }, 
    /**
    ...
    t.prototype.pa = function(t, e) {
        ...
        return po(t).ss({
            range: r,
            index: no.queryTargetsIndexName
        }, (function(t, n, r) {
            var o = Oi(n);
            // After finding a potential match, check that the target is
            // actually equal to the requested target.
                        At(e, o.target) && (i = o, r.done());
        })).next((function() {
            return i;
        }));
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = wi(e.path);
            i.push(o.put(new ro(n, s))), i.push(r.Co.Fa(t, n, e));
        })), Nr.$n(i);
    }, t.prototype.$a = function(t, e, n) {
        var r = this, i = yo(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return Nr.forEach(e, (function(e) {
            var o = wi(e.path);
            return Nr.$n([ i.delete([ n, o ]), r.Co.xa(t, n, e) ]);
        }));
    }, t.prototype.Sa = function(t, e) {
        var n = yo(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = yo(t), i = Kt();
        return r.ss({
            range: n,
            ns: !0
        }, (function(t, e, n) {
            var r = Ei(t[1]), o = new F(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.zo = function(t, e) {
        var n = wi(e.path), r = IDBKeyRange.bound([ n ], [ ct(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return yo(t).ss({
            index: ro.documentTargetsIndex,
            ns: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
 ...
 */
function po(t) {
    return wo.Un(t, no.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function vo(t) {
    return wo.Un(t, io.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function yo(t) {
    return wo.Un(t, ro.store);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var mo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", go = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Wo = t, r.Ma = n, r;
    }
    return t(n, e), n;
}(hi), wo = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        this.Co = new Eo(this, i), this.Ga = n + "main", this.serializer = new _i(a), this.za = new Ar(this.Ga, 10, new Ki(this.serializer)), 
        this.Ha = new lo(this.Co, this.serializer), this.Sr = new co, this.br = new Fi(this.serializer, this.Sr), 
    ...
    return t.Un = function(t, e) {
        if (t instanceof go) return Ar.Un(t.Wo, e);
        throw x();
    }, 
    /**
    ...
    t.prototype.start = function() {
        ...
        // do.
            ...
            throw new I(b.FAILED_PRECONDITION, mo);
    ...
    t.prototype.Ja = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Io(e).put(new uo(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return bo(t).get(Yi.key).next((function(t) {
            return Nr.resolve(e.cc(t));
        }));
    ...
    t.prototype.rc = function(t) {
        var e = this;
        return this.La ? Nr.resolve(!0) : bo(t).get(Yi.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Io(t).Zn().next((function(t) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.Tc(), [ 4 /*yield*/ , this.za.runTransaction("readwrite", [ Yi.store, uo.store ], (function(e) {
                        var n = new go(e, Hr.oi);
    ...
    t.prototype.Vi = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Io(e).Zn().next((function(e) {
        ...
        return this.za.runTransaction(o, ao, (function(o) {
            return i = new go(o, r.Ba ? r.Ba.next() : Hr.oi), "readwrite-primary" === e ? r.ic(i).next((function(t) {
                return !!t || r.rc(i);
            })).next((function(e) {
                if (!e) throw A("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r._n.Ds((function() {
                    return r.Ka(!1);
                })), new I(b.FAILED_PRECONDITION, ci);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.gc = function(t) {
        var e = this;
        return bo(t).get(Yi.key).next((function(t) {
            if (null !== t && e.lc(t.leaseTimestampMs, 5e3) && !e.dc(t.ownerId) && !e.cc(t) && !(e.La || e.allowTabSynchronization && t.allowTabSynchronization)) throw new I(b.FAILED_PRECONDITION, mo);
        }));
    }, 
    /**
    ...
    t.prototype.ac = function(t) {
        var e = new Yi(this.clientId, this.allowTabSynchronization, Date.now());
        return bo(t).put(Yi.key, e);
    }, t.On = function() {
        return Ar.On();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.oc = function(t) {
        var e = this, n = bo(t);
        return n.get(Yi.key).next((function(t) {
            return e.cc(t) ? (N("IndexedDbPersistence", "Releasing primary lease."), n.delete(Yi.key)) : Nr.resolve();
        }));
    }, 
 ...
 */
function bo(t) {
    return wo.Un(t, Yi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Io(t) {
    return wo.Un(t, uo.store);
}
...
/** Provides LRU functionality for IndexedDB persistence. */ var Eo = /** @class */ function() {
    ...
    t.prototype.bc = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Mi(t).rs((function(r) {
                return Ui(t, r, e).next((function(t) {
                    return t && (n = !0), Nr.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n.bc(t, s).next((function(e) {
                    ...
                    return o++, r.Ar(t, s).next((function() {
                        return r.Ir(s), yo(t).delete([ 0, wi(s.path) ]);
                    }));
                }));
                i.push(a);
            }
...
var No = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.Nc = wt.min(), this.vr = t.Ic(n), this.Fc = t.Rc(), this.Ha = t.Ac(), this.$c = new fi(this.Fc, this.vr, this.persistence.Pc()), 
        this.Sc.xc(this.$c);
    }
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Ht.forEach((function(a, c) {
                ...
                // cache.
                                c instanceof Gn && c.version.isEqual(wt.min()) ? (
                ...
                u = u.rt(a, c)) : N("LocalStore", "Ignoring outdated watch update for ", a, ". Current version:", h.version, " Watch version:", c.version), 
 ...
 */ function ko(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ha.Ca(t, e).next((function(i) {
            ...
            r = i, Nr.resolve(r)) : n.Ha.Ea(t).next((function(i) {
                return r = new kt(e, i, 0 /* Listen */ , t.Ma), n.Ha.ya(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function Oo(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = O(t), o = e.Dc.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 4:
                if (!xr(u = n.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return N("LocalStore", "Failed to update sequence numbers for target " + r + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function Ro(t, e, n) {
    var r = O(t), i = wt.min(), o = Kt();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = O(t), i = r.Cc.get(n);
            return void 0 !== i ? Nr.resolve(r.Dc.get(i)) : r.Ha.Ca(e, n);
        }(r, t, Jn(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ha.ka(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.Sc.Or(t, e, n ? i : wt.min(), n ? o : Kt());
        })).next((function(t) {
            return {
                documents: t,
                kc: o
...
// PORTING NOTE: Multi-Tab only.
function Lo(t, e) {
    var n = O(t), r = O(n.Ha), i = n.Dc.get(e);
 ...
 */ function Uo(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== b.FAILED_PRECONDITION || t.message !== ci) throw t;
 ...
 */ var Po = /** @class */ function() {
    function t() {
        ...
        this.Mc = new Ct(Vo.Oc), 
        // A set of outstanding references to a document sorted by target id.
        this.Lc = new Ct(Vo.Bc)
    ...
    t.prototype.Wc = function(t) {
        var e = this, n = new F(new V([])), r = new Vo(n, t), i = new Vo(n, t + 1), o = [];
        ...
        var e = new F(new V([])), n = new Vo(e, t), r = new Vo(e, t + 1), i = Kt();
        return this.Lc.Nt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.zo = function(t) {
        var e = new Vo(t, 0), n = this.Mc.$t(e);
    ...
    return t.Oc = function(t, e) {
        return F.i(t.key, e.key) || ut(t.Gc, e.Gc);
    }, 
    /** Compare by ID then by key */ t.Bc = function(t, e) {
        return ut(t.Gc, e.Gc) || F.i(t.key, e.key);
    }, t;
}(), Co = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = Yr.UNAUTHENTICATED, this.tu = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.eu !== e ? (N("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (k("string" == typeof n.accessToken), new Co(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.nu = function() {
        ...
        return k(null === t || "string" == typeof t), new Yr(t);
    }, t;
}(), qo = /** @class */ function() {
    function t(t, e) {
        this.su = t, this.iu = e, this.type = "FirstParty", this.user = Yr.ei;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new qo(this.su, this.iu));
    }, t.prototype.Jc = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.cu = 0, this.uu = null, this.stream = null, this.gs = new Tr(t, e)
        /**
    ...
    t.prototype.Au = function(t) {
        ...
        return function(n) {
            e._n.ds((function() {
                return e.cu === t ? n() : (N("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.gu = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                n = new ne(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Me(t, a.document.name), h = Ue(a.document.updateTime), f = new Vn({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = new qn(c, h, f, {}), p = a.targetIds || [], d = a.removedTargetIds || [];
                n = new te(p, d, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = Me(t, v.document), m = v.readTime ? Ue(v.readTime) : wt.min(), g = new Gn(y, m), w = v.removedTargetIds || [];
                n = new te([], w, g.key, g);
                ...
                var N = e.filter;
                N.targetId;
                var A = N.count || 0, S = new Ot(A), D = N.targetId;
                n = new ee(D, S);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? wt.min() : e.readTime ? Ue(e.readTime) : wt.min();
        }(t);
    ...
    n.prototype.vu = function(t) {
        var e = {};
        e.database = Ge(this.serializer), e.removeTarget = t, this.mu(e);
    }, n;
}(Bo), zo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    n.prototype.start = function() {
        ...
        k(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Su) {
        ...
        // The first response is always the handshake response
                return k(!t.writeResults || 0 === t.writeResults.length), this.Su = !0, 
        this.listener.Fu();
    }, 
    /**
    ...
    n.prototype.$u = function() {
        ...
        var t = {};
        t.database = Ge(this.serializer), this.mu(t);
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.qu ? (A(e), this.qu = !1) : N("OnlineStateTracker", e);
        ...
        i.ds((function() {
            return e(u, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return rs(this) ? (N("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = O(t)).Xu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Ho(e) ];
...
function $o(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = O(t), N("RemoteStore", "RemoteStore shutting down."), e.Xu.add(5 /* Shutdown */), 
                [ 4 /*yield*/ , Ho(e) ];
 ...
 */ function Jo(t, e) {
    var n = O(t), r = gs(n);
    n.Ju.delete(e), r.lu() && ts(n, e), 0 === n.Ju.size && (r.lu() ? r.du() : rs(n) && 
...
function ns(t) {
    return rs(t) && !gs(t).hu() && t.Ju.size > 0;
}

function rs(t) {
    return 0 === O(t).Xu.size;
}
...
function us(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.nh.set("Online" /* Online */), !(r instanceof ne && 2 /* Removed */ === r.state && r.cause)) 
              ...
              case 6:
                if (r instanceof te ? t.sh.pe(r) : r instanceof ee ? t.sh.$e(r) : t.sh.Se(r), i.isEqual(wt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , So(t.Gu) ];
              ...
              case 11:
                return N("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , as(t, u) ];
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Xu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ho(t) ];
                    ...
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Xu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Yo(t) ];
...
function hs(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = O(t), r = ws(e), i = e.Yu.length > 0 ? e.Yu[e.Yu.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , xo(e.Gu, i) ];
              ...
              case 4:
                return s = n.sent(), [ 4 /*yield*/ , as(e, s) ];
...
function fs(t) {
    return rs(t) && !ws(t).hu() && t.Yu.length > 0;
}
...
function ds(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = ws(t), r = 0, i = t.Yu; r < i.length; r++) o = i[r], e.Cu(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function vs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.Yu.shift(), o = ui.from(e, r, i), [ 4 /*yield*/ , cs(t, (function() {
                    return t.Hu.oh(o);
                })) ];
...
function ys(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(i) {
            switch (i.label) {
              case 0:
                return r && ws(t).Du ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return Rt(i = r.code) && i !== b.ABORTED ? (e = t.Yu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                ws(t).fu(), [ 4 /*yield*/ , cs(t, (function() {
 ...
 */ function ms(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = O(t), r ? (e.Xu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Yo(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = r) ? [ 3 /*break*/ , 4 ] : (e.Xu.add(2 /* IsSecondary */), [ 4 /*yield*/ , Ho(e) ]);
    ...
    t.uh = function(t, e, n) {
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.uh.fu(), ns(t) ? es(t) : t.nh.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function ws(t) {
    ...
    t.hh = function(t, e, n) {
        var r = O(t);
        return r.ku(), new zo(e, r.ou, r.credentials, r.serializer, n);
    }(t.zu, t.os, {
        yu: ps.bind(null, t),
        Iu: ys.bind(null, t),
        Fu: ds.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.hh.fu(), [ 4 /*yield*/ , hs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.Yu.length > 0 && (N("RemoteStore", "Stopping write stream with " + t.Yu.length + " pending writes"), 
                    t.Yu = []), e.label = 4;
...
var bs = function(t) {
    ...
    e) {
        ...
        this.Qt = Kt(), this.dh = sr(t), this.wh = new Ht(this.dh);
    }
    ...
    t.prototype.Th = function(t, e) {
        var n = this, r = e ? e.Eh : new $t, i = e ? e.wh : this.wh, o = e ? e.Qt : this.Qt, s = i, u = !1, a = Kn(this.query) && i.size === this.query.limit ? i.last() : null, c = Wn(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.ut((function(t, e) {
            var h = i.get(t), f = e instanceof qn ? e : null;
            f && (f = or(n.query, f) ? f : null);
            ...
            o = o.delete(t)));
        })), Kn(this.query) || Wn(this.query)) for (;s.size > this.query.limit; ) {
            var h = Kn(this.query) ? s.last() : s.first();
    ...
    t.prototype.gr = function(t, e, n) {
        ...
        return this._h = u, 0 !== o.length || a ? {
            snapshot: new Xt(this.query, t.wh, i, o, t.Qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            gh: s
        } : {
            gh: s
    ...
    t.prototype.Rh = function(t) {
        ...
        // updating many documents.
                var e = this.fh;
        this.fh = Kt(), this.wh.forEach((function(e) {
            t.yh(e.key) && (t.fh = t.fh.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.fh.has(e) || n.push(new Is(e));
    ...
    // PORTING NOTE: Multi-tab only.
    t.prototype.ph = function() {
        return Xt.Kt(this.query, this.wh, this.Qt, 0 /* Local */ === this._h);
    }, t;
}(), _s = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.Fh = {}, this.$h = new mt((function(t) {
            return rr(t);
        }), nr), this.xh = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Oh = new Map, this.Lh = new Po, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Bh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.qh = new Map, this.Uh = fo.Ta(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , ko(e.Gu, Jn(r)) ];

              case 2:
                return u = n.sent(), a = e.Ch.Mi(u.targetId), i = u.targetId, [ 4 /*yield*/ , Ss(e, r, i, "current" === a) ];

              case 3:
                o = n.sent(), e.Wh && Xo(e.Sh, u), n.label = 4;
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(l) {
            switch (l.label) {
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.Th(i), e.Ah ? [ 4 /*yield*/ , Ro(t.Gu, r.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.Wh, s), [ 2 /*return*/ , (Ms(t, r.targetId, u.gh), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return s = l.sent(), u = new Es(r, s.kc), a = u.Th(s.documents), c = Zt.Xt(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.gr(a, 
                /* updateLimboDocuments= */ t.Wh, c), Ms(t, i, h.gh), f = new _s(r, i, u), [ 2 /*return*/ , (t.$h.set(r, f), 
...
/** Stops listening to the query. */ function Ds(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = O(t), i = e.$h.get(r), (o = e.xh.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.xh.set(i.targetId, o.filter((function(t) {
                    return !nr(t, r);
                }))), void e.$h.delete(r)) ] : e.Wh ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                e.Ch.Li(i.targetId), e.Ch.Ni(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Oo(e.Gu, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    e.Ch.qi(i.targetId), Jo(e.Sh, i.targetId), Vs(e, i.targetId);
                })).catch(Uo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Vs(e, i.targetId), [ 4 /*yield*/ , Oo(e.Gu, i.targetId, 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Do(e.Gu, r) ];
              ...
              case 2:
                ...
                r.Gt.forEach((function(t, n) {
                    ...
                    k(t.te.size + t.ee.size + t.ne.size <= 1), t.te.size > 0 ? r.bh = !0 : t.ee.size > 0 ? k(r.bh) : t.ne.size > 0 && (k(r.bh), 
                    r.bh = !1));
                })), [ 4 /*yield*/ , Gs(e, i, r) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = O(t)).Ch.Ui(r, "rejected", i), o = e.Oh.get(r), (s = o && o.key) ? (u = (u = new Ut(F.i)).rt(s, new Gn(s, wt.min())), 
                a = Kt().add(s), c = new Jt(wt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Ct(ut), u, a), [ 4 /*yield*/ , xs(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.Mh = e.Mh.remove(s), e.Oh.delete(r), qs(e), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , Oo(e.Gu, r, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Vs(e, r, i);
                })).catch(Uo) ];
...
function Rs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = O(t), i = r.batch.batchId, n.label = 1;

              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Ao(e.Gu, r) ];
              ...
              case 2:
                ...
                Ps(e, i, /*error=*/ null), Us(e, i), e.Ch.xi(i, "acknowledged"), [ 4 /*yield*/ , Gs(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                // listen events.
                Ps(e, r, i), Us(e, r), e.Ch.xi(r, "rejected", i), [ 4 /*yield*/ , Gs(e, o) ];
...
function Ps(t, e, n) {
    var r = O(t), i = r.Bh[r.currentUser.Zs()];
...
function Cs(t, e) {
    ...
    var n = t.Mh.get(e);
    null !== n && (Jo(t.Sh, n), t.Mh = t.Mh.remove(e), t.Oh.delete(n), qs(t));
}

function Ms(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof bs ? (t.Lh.Fa(o.key, e), Fs(t, o)) : o instanceof Is ? (N("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Fs(t, e) {
    var n = e.key;
    t.Mh.get(n) || (N("SyncEngine", "New document in limbo: " + n), t.kh.push(n), qs(t));
}
 ...
 */ function qs(t) {
    for (;t.kh.length > 0 && t.Mh.size < t.Nh; ) {
        ...
        t.Oh.set(n, new Ts(e)), t.Mh = t.Mh.rt(e, n), Xo(t.Sh, new kt(Jn(Qn(e.path)), n, 2 /* LimboResolution */ , Hr.oi));
    }
}
                            ...
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Nr.forEach(r, (function(n) {
                                        return Nr.forEach(n.jr, (function(r) {
                                            return e.persistence.Co.Fa(t, n.targetId, r);
                                        })).next((function() {
                                            return Nr.forEach(n.Kr, (function(r) {
...
function Bs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                return (i = O(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (N("SyncEngine", "User change. New user:", r.Zs()), 
                [ 4 /*yield*/ , 
                /**
                ...
                function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return e = O(t), i = e.vr, o = e.$c, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                    ...
                                    return e.vr.qo(t).next((function(s) {
                                        ...
                                        // MutationQueue.
                                        o = new fi(e.Fc, i, e.persistence.Pc()), i.qo(t);
                                    })).next((function(e) {
              ...
              case 1:
                ...
                i.Ch.Wi(r, o.zh, o.Hh), [ 4 /*yield*/ , Gs(i, o.Gh) ];
...
function js(t, e) {
    var n = O(t), r = n.Oh.get(e);
    if (r && r.bh) return Kt().add(r.key);
    var i = Kt(), o = n.xh.get(e);
    if (!o) return i;
 ...
 */ function zs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Ro((e = O(t)).Gu, r.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = n.sent(), o = r.view.Vh(i), [ 2 /*return*/ , (e.Wh && Ms(e, r.targetId, o.gh), 
                o) ];
            }
        }));
    }));
        ...
        return n(this, (function(n) {
            switch (n.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Oo(t, e).next((function(e) {
                            return e ? n.$c.$r(t, e) : Nr.resolve(null);
                        }));
                    }));
                }((e = O(t)).Gu, r) ];

              case 1:
                return null === (s = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , hs(e.Sh) ];
              ...
              case 3:
                ...
                // other clients.
                Ps(e, r, o || null), Us(e, r), function(t, e) {
                    O(O(t).vr).jo(e);
                }(e.Gu, r)) : x(), n.label = 4;

              case 4:
                return [ 4 /*yield*/ , Gs(e, s) ];
...
function Ks(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return Js(e = O(t)), Zs(e), !0 !== r || !0 === e.Qh ? [ 3 /*break*/ , 3 ] : (i = e.Ch.Di(), 
                [ 4 /*yield*/ , Ws(e, i.A()) ]);

              case 1:
                return o = n.sent(), e.Qh = !0, [ 4 /*yield*/ , ms(e.Sh, !0) ];

              case 2:
                for (n.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Xo(e.Sh, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Oh.forEach((function(t, n) {
                        Jo(e.Sh, n);
                    })), e.Lh.jc(), e.Oh = new Map, e.Mh = new Ut(F.i);
                }(e), e.Qh = !1, [ 4 /*yield*/ , ms(e.Sh, !1) ];
...
function Ws(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = O(t), i = [], o = [], s = 0, u = r, n.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = e.xh.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , ko(e.Gu, Jn(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (p = l[f], d = e.$h.get(p), [ 4 /*yield*/ , zs(e, d) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Lo(e.Gu, a) ];

              case 8:
                return y = n.sent(), [ 4 /*yield*/ , ko(e.Gu, y) ];

              case 9:
                return c = n.sent(), [ 4 /*yield*/ , Ss(e, Ys(y), a, 
                /*current=*/ !1) ];
...
function Hs(t) {
    var e = O(t);
    return O(O(e.Gu).persistence).Vi();
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 3:
                return s = n.sent(), u = Jt.Jt(r, "current" === i), [ 4 /*yield*/ , Gs(e, s, u) ];
              ...
              case 6:
                return n.sent(), Vs(e, r, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Xs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(d) {
            switch (d.label) {
              case 0:
                if (!(e = Js(t)).Qh) return [ 3 /*break*/ , 10 ];
                o = 0, s = r, d.label = 1;

              case 1:
                return o < s.length ? (u = s[o], e.xh.has(u) ? (
                // A target might have been added in a previous attempt
                N("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Lo(e.Gu, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = d.sent(), [ 4 /*yield*/ , ko(e.Gu, a) ];

              case 3:
                return c = d.sent(), [ 4 /*yield*/ , Ss(e, Ys(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                d.sent(), Xo(e.Sh, c), d.label = 5;
              ...
              case 6:
                h = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.xh.has(t) ? [ 4 /*yield*/ , Oo(e.Gu, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Jo(e.Sh, t), Vs(e, t);
                            })).catch(Uo) ] : [ 3 /*break*/ , 2 ];
...
function Js(t) {
    var e = O(t);
    return e.Sh.Hu.rh = xs.bind(null, e), e.Sh.Hu.Be = js.bind(null, e), e.Sh.Hu.ih = Os.bind(null, e), 
    e.Fh.pu = zr.bind(null, e.Dh), e.Fh.Kh = Qr.bind(null, e.Dh), e;
}

function Zs(t) {
    var e = O(t);
    return e.Sh.Hu.oh = Rs.bind(null, e), e.Sh.Hu.ah = Ls.bind(null, e), e;
}
 ...
 */ var tu = /** @class */ function() {
    ...
    return t.prototype.xc = function(t) {
        ...
        }(e) || n.isEqual(wt.min()) ? this.Jh(t, e) : this.Yh.$r(t, r).next((function(o) {
            var u = i.Xh(e, o);
            return (Kn(e) || Wn(e)) && i.Ah(e.on, u, r, n) ? i.Jh(t, e) : (T() <= s.DEBUG && N("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ir(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Xh = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof qn && or(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.Ah = function(t, e, n, r) {
        ...
        return T() <= s.DEBUG && N("IndexFreeQueryEngine", "Using full collection scan to execute query:", ir(e)), 
    ...
    function t(t, e) {
        ...
        this.tl = new Ct(Vo.Oc);
    }
    return t.prototype.$o = function(t) {
        return Nr.resolve(0 === this.vr.length);
    }, t.prototype.xo = function(t, e, n, r) {
        var i = this.Zh;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.tl = this.tl.add(new Vo(a.key, i)), this.Sr.ko(t, a.key.path.h());
        }
        return Nr.resolve(o);
    }, t.prototype.Mo = function(t, e) {
        return Nr.resolve(this.el(e));
    }, t.prototype.Lo = function(t, e) {
        var n = e + 1, r = this.nl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Nr.resolve(this.vr.length > i ? this.vr[i] : null);
    }, t.prototype.Bo = function() {
        return Nr.resolve(0 === this.vr.length ? -1 : this.Zh - 1);
    }, t.prototype.qo = function(t) {
        return Nr.resolve(this.vr.slice());
    }, t.prototype.Cr = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                F.F(i) || (i = i.child(""));
        var o = new Vo(new F(i), 0), s = new Ct(ut);
        ...
        var n = this;
        k(0 === this.il(e.batchId, "removed")), this.vr.shift();
        var r = this.tl;
        ...
        var n = new Vo(e, 0), r = this.tl.$t(n);
        return Nr.resolve(e.isEqual(r && r.key));
    }, t.prototype.Go = function(t) {
        return this.vr.length, Nr.resolve();
    }, 
    /**
    ...
    t.prototype.Ir = function(t) {
        ...
        for (var r = jt(), i = new F(e.path.child("")), o = this.docs._t(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.It(); ) {
            var s = o.Et(), u = s.key, a = s.value, c = a.Zo, h = a.readTime;
            if (!e.path.T(u.path)) break;
            h.L(n) <= 0 || c instanceof qn && or(e, c) && (r = r.rt(c.key, c));
        }
        return Nr.resolve(r);
...
var ru = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.ul = new Po, this.targetCount = 0, this.hl = fo.ma();
    }
    return t.prototype.De = function(t, e) {
        ...
        return Nr.resolve(this.cl);
    }, t.prototype.Ea = function(t) {
        return this.highestTargetId = this.hl.next(), Nr.resolve(this.highestTargetId);
    }, t.prototype.ga = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.hl = new fo(e), this.highestTargetId = e), t.sequenceNumber > this.cl && (this.cl = t.sequenceNumber);
    }, t.prototype.ya = function(t, e) {
        return this.Va(e), this.targetCount += 1, Nr.resolve();
    }, t.prototype.ba = function(t, e) {
        return this.Va(e), Nr.resolve();
    }, t.prototype.va = function(t, e) {
        ...
        return this.ul.qc(e, n), Nr.resolve();
    }, t.prototype.$a = function(t, e, n) {
        this.ul.Qc(e, n);
        ...
        return this.ul.Wc(e), Nr.resolve();
    }, t.prototype.ka = function(t, e) {
        var n = this.ul.Kc(e);
        return Nr.resolve(n);
    }, t.prototype.zo = function(t, e) {
        return Nr.resolve(this.ul.zo(e));
    }, t;
}(), iu = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.ll = {}, this.Ba = new Hr(0), this.qa = !1, this.qa = !0, this.Co = t(this), 
        this.Ha = new ru(this), this.Sr = new zi, this.br = new nu(this.Sr, (function(t) {
            return e.Co._l(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.ll[t.Zs()];
        return e || (e = new eu(this.Sr, this.Co), this.ll[t.Zs()] = e), e;
    }, t.prototype.Ac = function() {
        return this.Ha;
    }, t.prototype.Rc = function() {
        return this.br;
        ...
        return Nr.xn(Object.values(this.ll).map((function(n) {
            return function() {
                return n.zo(t, e);
            };
        })));
    ...
    return t.El = function(e) {
        ...
        return this.ml.Fa(n, e), this.Il.delete(n.toString()), Nr.resolve();
    }, t.prototype.xa = function(t, e, n) {
        return this.ml.xa(n, e), this.Il.add(n.toString()), Nr.resolve();
    }, t.prototype.Ko = function(t, e) {
        return this.Il.add(e.toString()), Nr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Nr.forEach(this.Il, (function(r) {
            var i = F.D(r);
    ...
    return t(n, e), n.prototype.$l = function(t, e, n, r) {
            ...
            s.listenOnce(v.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case y.TIMEOUT:
                        N("Connection", 'RPC "' + t + '" timed out'), o(new I(b.DEADLINE_EXCEEDED, "Request time out"));
                        break;
        ...
        var s = r.createWebChannel(o, i), u = !1, d = !1, v = new uu({
            Rl: function(t) {
                d ? N("Connection", "Not sending because WebChannel is closed:", t) : (u || (N("Connection", "Opening WebChannel transport."), 
                s.open(), u = !0), N("Connection", "WebChannel sending:", t), s.send(t));
            },
            Pl: function() {
                return s.close();
            }
        ...
        return y(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, N("Connection", "WebChannel transport closed"), v.bl());
        })), y(g.EventType.ERROR, (function(t) {
            d || (d = !0, S("Connection", "WebChannel transport errored:", t), v.bl(new I(b.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                } else N("Connection", "WebChannel received:", n), v.vl(n);
            }
        })), setTimeout((function() {
    ...
    t.prototype.Fl = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/7.21.1-2020822235757", 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var pu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", du = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new tu, r = t.Kl, new No(e, n, r);
        var e, n, r;
    }, t.prototype.Ul = function(t) {
        if (t.persistenceSettings.Gl) throw new I(b.FAILED_PRECONDITION, pu);
        return new iu(su.El);
        ...
        throw new I(b.FAILED_PRECONDITION, pu);
    }, t;
}(), vu = /** @class */ function(r) {
    function i() {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.zl._i, this.Ch instanceof ii ? (this.Ch._i = {
                        tr: Qs.bind(null, i),
                        er: $s.bind(null, i),
                        nr: Xs.bind(null, i),
                        Vi: Hs.bind(null, i)
                    ...
                    return [ 4 /*yield*/ , this.persistence.ec((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Ks(this.zl._i, t) ];
        ...
        if (t.persistenceSettings.Gl && t.persistenceSettings.synchronizeTabs) {
            var e = Pr();
            if (!ii.On(e)) throw new I(b.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var n = To(t.Sl.U, t.Sl.persistenceKey);
            return new ii(e, t.os, n, t.clientId, t.Kl);
        }
        return new oi;
    }, i;
}(/** @class */ function(r) {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    return i.sent(), [ 4 /*yield*/ , function(t) {
                        return e(this, void 0, void 0, (function() {
                            var e, r;
                            return n(this, (function(n) {
                                return e = O(t), r = O(e.Fc), [ 2 /*return*/ , e.persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                                    return r.oa(t);
                                })).then((function(t) {
                                    e.Nc = t;
                                })) ];
                  ...
                  case 3:
                    ...
                    return i.sent(), [ 4 /*yield*/ , Zs(this.zl._i) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return i.sent(), [ 4 /*yield*/ , hs(this.zl.Sh) ];
        ...
        return new mi(e, t.os);
    }, i.prototype.Ul = function(t) {
        var e = To(t.Sl.U, t.Sl.persistenceKey), n = lu(t.Sl.U);
        return new wo(t.persistenceSettings.synchronizeTabs, e, t.clientId, yi.oo(t.persistenceSettings.cacheSizeBytes), t.os, Pr(), Vr(), n, this.Ch, t.persistenceSettings.La);
    }, i.prototype.ql = function(t) {
        return new oi;
        ...
        return function(t) {
            return e(this, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return Ar.On() ? (e = t + "main", [ 4 /*yield*/ , Ar.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
    ...
    return t.prototype.initialize = function(t, r) {
                ...
                switch (n.label) {
                  case 0:
                    ...
                    this.Sh = this.Yl(r), this.Dh = this.Jl(r), this._i = this.Xl(r), this.Ch.fi = function(t) {
                        return ks(e._i, t, 1 /* SharedClientState */);
                    }, this.Sh.Hu.Zl = Bs.bind(null, this._i), [ 4 /*yield*/ , ms(this.Sh, this._i.Wh) ]);
        ...
        var e, n = lu(t.Sl.U), r = (e = t.Sl, new cu(e));
        ...
        return e = this.Gu, n = this.zu, r = t.os, i = function(t) {
            return ks(s._i, t, 0 /* RemoteStore */);
        }, o = hu.On() ? new hu : new fu, new Wo(e, n, r, i, o);
...
var Tu = /** @class */ function(e) {
...
}(Iu), Su = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).i_ = t, r.l_ = n, r;
    }
    return t(n, e), n.prototype.r_ = function(t) {
        var e = new dn(t.serializer, ke(t.serializer, this.l_));
        return new gn(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Iu), Du = /** @class */ function(e) {
    function n() {
        return e.call(this) || this;
    }
    return t(n, e), n.delete = function() {
        return q("FieldValue.delete", arguments), new xu(new Eu("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return q("FieldValue.serverTimestamp", arguments), new xu(new Tu("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return B("FieldValue.arrayUnion", arguments, 1), new xu(new Nu("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return B("FieldValue.arrayRemove", arguments, 1), new xu(new Au("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return z("FieldValue.increment", "number", 1, t), G("FieldValue.increment", arguments, 1), 
        new xu(new Su("FieldValue.increment", t));
    }, n;
}(Iu), xu = /** @class */ function(e) {
    function n(t) {
        var n = this;
    ...
    function t(t, e) {
        if (G("GeoPoint", arguments, 2), z("GeoPoint", "number", 1, t), z("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.H = function(t) {
        return ut(this.__, t.__) || ut(this.f_, t.f_);
    }, t;
}(), Ou = /^__.*__$/, Ru = function(t, e, n) {
    ...
    return t.prototype.T_ = function(t, e) {
        var n = [];
        return null !== this.Qe ? n.push(new xn(t, this.data, this.Qe, e)) : n.push(new Dn(t, this.data, e)), 
    ...
    return t.prototype.T_ = function(t, e) {
        var n = [ new xn(t, this.data, this.Qe, e) ];
...
/** A "context" object passed around while parsing user data. */ var Vu = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.I_ = function(e) {
        ...
        return Yu(t, this.settings.methodName, this.settings.y_ || !1, this.path, this.settings.c_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Pu(this.o_) && Ou.test(t)) throw this.a_('Document fields cannot begin and end with "__"');
    }, t;
}(), Cu = /** @class */ function() {
    function t(t, e, n) {
        this.U = t, this.ignoreUndefinedProperties = e, this.serializer = n || lu(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.V_ = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Vu({
            o_: t,
            methodName: e,
            c_: n,
            path: M.g(),
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Mu(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.V_(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Qu("Data must be an object, but it was:", s, r);
    var u, a, c = ju(r, s);
    if (o.merge) u = new mn(s.Qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = l[f], d = void 0;
            if (p instanceof gu) d = p.n_; else {
    ...
    return new Lu(new Vn(c), u, a);
}

/** Parse update data from an update() call. */ function Fu(t, e, n, r) {
    var i = t.V_(1 /* Update */ , e, n);
    Qu("Data must be an object, but it was:", i, r);
    var o = [], s = new Cn;
    L(r, (function(t, r) {
        var u = Wu(e, t, n), a = i.P_(u);
        if (r instanceof Iu && r.s_ instanceof Eu) 
...
/** Parse update data from a list of field/value arguments. */ function qu(t, e, n, r, i, o) {
    var s = t.V_(1 /* Update */ , e, n), u = [ Ku(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Ku(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new Cn, l = u.length - 1; l >= 0; --l) if (!Hu(h, u[l])) {
        var p = u[l], d = a[l], v = s.P_(p);
        if (d instanceof Iu && d.s_ instanceof Eu) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var y = Bu(d, v);
 ...
 */ function Gu(t, e, n, r) {
    return void 0 === r && (r = !1), Bu(n, t.V_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Bu(t, e) {
    if (zu(t)) return Qu("Unsupported field value:", e, t), ju(t, e);
    if (t instanceof Iu) 
    ...
    return function(t, e) {
        ...
        if (!Pu(e.o_)) throw e.a_(t.i_ + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof Ru) {
            ...
            return {
                referenceValue: Pe(t.d_ || e.U, t.w_.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.a_("Unsupported field value: " + J(t));
    }(t, e);
}
...
function zu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof gt || t instanceof ku || t instanceof ft || t instanceof Ru || t instanceof Iu);
}
 ...
 */ function Ku(t, e, n) {
    if (e instanceof gu) return e.n_;
 ...
 */ function Wu(t, e, n) {
    try {
        return function(t) {
            if (t.search(bu) >= 0) throw new I(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (wu.bind.apply(wu, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new I(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).n_;
    } catch (e) {
        throw Yu((i = e) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
 ...
 */ var $u = /** @class */ function() {
    ...
    return t.prototype.D_ = function(t) {
                ...
                switch (o.label) {
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = O(t), i = Ge(e.serializer) + "/documents", o = {
                                    ...
                                    return s = n.sent(), u = new Map, s.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Me(t, e.found.name), r = Ue(e.found.updateTime), i = new Vn({
                                                    mapValue: {
                                                ...
                                                var n = Me(t, e.missing), r = Ue(e.readTime);
                                                return new Gn(n, r);
                                            }(t, e) : x();
                                        }(e.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof Gn || t instanceof qn ? i.N_(t) : x();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new Un(t, this.Ke(t)) ]), this.S_.add(t.toString());
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = F.D(e);
                        r.mutations.push(new Pn(n, r.Ke(n)));
    ...
    t.prototype.Ke = function(t) {
        ...
        return !this.S_.has(t.toString()) && e ? bn.updateTime(e) : bn.Ge();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.os = t, this.zu = e, this.updateFunction = n, this.hs = r, this.x_ = 5, this.gs = new Tr(this.os, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.gs.Rn((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new $u(this.zu), (e = this.M_(t)) && e.then((function(e) {
                        r.os.ds((function() {
        ...
        try {
            ...
            return !bt(e) && e.catch && e.then ? e : (this.hs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
     ...
     */
    e) {
        this.credentials = t, this.os = e, this.clientId = st.k(), 
    ...
    return t.prototype.start = function(t, r, i, o) {
        ...
        return this.credentials.Jc((function(t) {
            if (!a) return a = !0, N("FirestoreClient", "Initializing. user=", t.uid), s.U_(r, i, o, t, u).then(s.B_.resolve, s.B_.reject);
            s.os.Ds((function() {
                return function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return (e = O(t)).os.Fs(), N("RemoteStore", "RemoteStore received new credentials"), 
                                i = rs(e), 
                                // Tear down and re-create our network streams. This will ensure we get a
                                // fresh auth token for the new user and re-fill the write pipeline with
                                // new mutations from the LocalStore (since mutations are per-user).
                                e.Xu.add(3 /* CredentialChange */), [ 4 /*yield*/ , Ho(e) ];
                              ...
                              case 2:
                                return n.sent(), e.Xu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Yo(e) ];
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        ...
        return this.q_(), this.os.enqueue((function() {
            return t.persistence.sc(!0), function(t) {
                var e = O(t);
                return e.Xu.delete(0 /* UserDisabled */), Yo(e);
            }(t.Sh);
        }));
    }, 
    /**
            ...
            return n(this, (function(h) {
                switch (h.label) {
                  ...
                  case 2:
                    ...
                    this.Q_.qs = As.bind(null, this._i), this.Q_.Ws = Ds.bind(null, this._i), 
            ...
            return t.persistence.sc(!1), function(t) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return (e = O(t)).Xu.add(0 /* UserDisabled */), [ 4 /*yield*/ , Ho(e) ];
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        ...
                        this.Ql && this.Ql.stop(), [ 4 /*yield*/ , $o(this.Sh) ];
                      ...
                      case 4:
                        return t = n.sent(), e = Fr(t, "Failed to shutdown persistence"), r.reject(e), [ 3 /*break*/ , 5 ];
            ...
            return function(t, r) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            rs((e = O(t)).Sh) || N("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                            n.label = 1;
                          ...
                          case 3:
                            return s = n.sent(), u = Fr(s, "Initialization of waitForPendingWrites() operation failed"), 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    return o.sent(), r = new _r, [ 2 /*return*/ , (this.os.ds((function() {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return (e = n.sent()) instanceof qn ? i.resolve(e) : e instanceof Gn ? i.resolve(null) : i.reject(new I(b.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = n.sent(), s = Fr(o, "Failed to get document '" + r + " from cache"), 
        ...
        return void 0 === r && (r = {}), e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), e = new _r, [ 2 /*return*/ , (this.os.ds((function() {
                        ...
                        return function(t, r, i) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Ro(t, r, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return e = n.sent(), o = new Es(r, e.kc), s = o.Th(e.documents), u = o.gr(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = Fr(a, "Failed to execute query '" + r + " against cache"), 
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            ...
                            function(t, e) {
                                var n, r = O(t), i = gt.now(), o = e.reduce((function(t, e) {
                                    return t.add(e.key);
                                }), Kt());
                                return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                                    return r.$c.$r(t, o).next((function(o) {
                                        ...
                                        var s = [], u = 0, a = e; u < a.length; u++) {
                                            ...
                                            // exists=true
                                            s.push(new xn(c.key, h, Mn(h.proto.mapValue), bn.exists(!0)));
                                        }
                          ...
                          case 2:
                            return o = n.sent(), e.Ch.Fi(o.batchId), function(t, e, n) {
                                ...
                                r || (r = new Ut(ut)), r = r.rt(e, n), t.Bh[t.currentUser.Zs()] = r;
                            }(e, o.batchId, i), [ 4 /*yield*/ , Gs(e, o.dr) ];

                          case 3:
                            return n.sent(), [ 4 /*yield*/ , hs(e.Sh) ];

                          case 4:
                            return n.sent(), [ 3 /*break*/ , 6 ];

                          case 5:
                            return s = n.sent(), u = Fr(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new _r;
        return this.os.ds((function() {
            return new Xu(e.os, e.zu, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var ta = /** @class */ function() {
    ...
    return t.prototype.tf = function(t) {
        switch (he(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.Z_(ge(t.bytesValue));
        ...
        return new ku(me(t.latitude), me(t.longitude));
        ...
        var e = ye(t), n = new gt(e.seconds, e.nanos);
        ...
        A("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.U.projectId + "/" + this.U.database + ") instead."), 
        this.X_(r);
    }, t;
}(), ea = yi.uo, na = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
        ...
        W("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = yi.lo; else {
            if (t.cacheSizeBytes !== ea && t.cacheSizeBytes < yi.ho) throw new I(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + yi.ho);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new du), void 0 === s && (s = new yu), this.cf = o, this.uf = s, 
        this.hf = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.lf = new Mr, this.INTERNAL = {
            delete: function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
            ...
            var a = r;
            this.hf = a, this.d_ = t.df(a), this.wf = a.name, this.mf = new Fo(i);
        } else {
            var c = r;
            if (!c.projectId) throw new I(b.INVALID_ARGUMENT, "Must provide projectId");
            this.d_ = new yt(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.wf = "[DEFAULT]", this.mf = new Mo;
        }
        this.Tf = new na({});
    }
    return Object.defineProperty(t.prototype, "Ef", {
        get: function() {
            ...
            this.If = new Cu(this.d_, this.Tf.ignoreUndefinedProperties)), this.If;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        G("Firestore.settings", arguments, 1), z("Firestore.settings", "object", 1, t), 
        t.merge && 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                ...
                return t = new _r, [ 2 /*return*/ , (this.lf.ps((function() {
                    return e(r, void 0, void 0, (function() {
                        var e;
                        return n(this, (function(n) {
                            switch (n.label) {
        ...
        if (this._f(), Zu(t)) return this.ff.H_(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Af(new du, new yu, {
            Gl: !1
        }), this.ff;
    }, t.prototype.Pf = function() {
        return new vt(this.d_, this.wf, this.Tf.host, this.Tf.ssl, this.Tf.experimentalForceLongPolling);
    }, t.prototype.Af = function(t, e, n) {
        var r = this.Pf();
        return this.ff = new Ju(this.mf, this.lf), this.ff.start(r, t, e, n);
    }, t.df = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I(b.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return G("Firestore.collection", arguments, 1), z("Firestore.collection", "non-empty string", 1, t), 
        this._f(), new ga(V.P(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return G("Firestore.doc", arguments, 1), z("Firestore.doc", "non-empty string", 1, t), 
        this._f(), sa.gf(V.P(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (G("Firestore.collectionGroup", arguments, 1), z("Firestore.collectionGroup", "non-empty string", 1, t), 
 ...
 */
        ...
        var e = this;
        return G("Firestore.runTransaction", arguments, 1), z("Firestore.runTransaction", "function", 1, t), 
        this._f().transaction((function(n) {
            return t(new ia(e, n));
        }));
    }, t.prototype.batch = function() {
        return this._f(), new oa(this);
        ...
        var e;
        G("Firestore.setLogLevel", arguments, 1), H("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, _.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        var e = this;
        G("Transaction.get", arguments, 1);
        var n = Ea("Transaction.get", t, this.pf);
        return this.bf.D_([ n.w_ ]).then((function(t) {
            if (!t || 1 !== t.length) return x();
            var r = t[0];
            if (r instanceof Gn) return new aa(e.pf, n.w_, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            if (r instanceof qn) return new aa(e.pf, n.w_, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            throw x();
        }));
        ...
        var r = Ea("Transaction.set", t, this.pf);
        n = wa("Transaction.set", n);
        var i = Ta(r.m_, e, n), o = Mu(this.pf.Ef, "Transaction.set", r.w_, i, null !== r.m_, n);
        return this.bf.set(r.w_, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof wu ? (B("Transaction.update", arguments, 3), 
        r = Ea("Transaction.update", t, this.pf), i = qu(this.pf.Ef, "Transaction.update", r.w_, e, n, o)) : (G("Transaction.update", arguments, 2), 
        r = Ea("Transaction.update", t, this.pf), i = Fu(this.pf.Ef, "Transaction.update", r.w_, e)), 
        this.bf.update(r.w_, i), this;
    }, t.prototype.delete = function(t) {
        G("Transaction.delete", arguments, 1);
        var e = Ea("Transaction.delete", t, this.pf);
    ...
    return t.prototype.set = function(t, e, n) {
        j("WriteBatch.set", arguments, 2, 3), this.Df();
        var r = Ea("WriteBatch.set", t, this.pf);
        n = wa("WriteBatch.set", n);
        var i = Ta(r.m_, e, n), o = Mu(this.pf.Ef, "WriteBatch.set", r.w_, i, null !== r.m_, n);
        return this.vf = this.vf.concat(o.T_(r.w_, bn.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Df(), "string" == typeof e || e instanceof wu ? (B("WriteBatch.update", arguments, 3), 
        r = Ea("WriteBatch.update", t, this.pf), i = qu(this.pf.Ef, "WriteBatch.update", r.w_, e, n, o)) : (G("WriteBatch.update", arguments, 2), 
        r = Ea("WriteBatch.update", t, this.pf), i = Fu(this.pf.Ef, "WriteBatch.update", r.w_, e)), 
        this.vf = this.vf.concat(i.T_(r.w_, bn.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        G("WriteBatch.delete", arguments, 1), this.Df();
        var e = Ea("WriteBatch.delete", t, this.pf);
        return this.vf = this.vf.concat(new Un(e.w_, bn.Ge())), this;
    }, t.prototype.commit = function() {
    ...
    return t(n, e), n.gf = function(t, e, r) {
        ...
        get: function() {
            return new ga(this.w_.path.h(), this.firestore, this.m_);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (G("DocumentReference.collection", arguments, 1), z("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new I(b.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V.P(t);
        return new ga(this.w_.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        ...
        j("DocumentReference.set", arguments, 1, 2), e = wa("DocumentReference.set", e);
        var n = Ta(this.m_, t, e), r = Mu(this.firestore.Ef, "DocumentReference.set", this.w_, n, null !== this.m_, e);
        return this.ff.write(r.T_(this.w_, bn.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof wu ? (B("DocumentReference.update", arguments, 2), 
        n = qu(this.firestore.Ef, "DocumentReference.update", this.w_, t, e, r)) : (G("DocumentReference.update", arguments, 1), 
        n = Fu(this.firestore.Ef, "DocumentReference.update", this.w_, t)), this.ff.write(n.T_(this.w_, bn.exists(!0)));
    }, n.prototype.delete = function() {
        return G("DocumentReference.delete", arguments, 0), this.ff.write([ new Un(this.w_, bn.Ge()) ]);
        ...
        "object" != typeof i[u] || Zu(i[u]) || (tt("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else z("DocumentReference.onSnapshot", "function", u, i[u]), Q("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        Q("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.Cf(t));
            },
        ...
        return this.ff.listen(Qn(this.w_.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        j("DocumentReference.get", arguments, 0, 1), Ia("DocumentReference.get", t);
        var n = this.firestore._f();
        return t && "cache" === t.source ? n.j_(this.w_).then((function(t) {
            return new aa(e.firestore, e.w_, t, 
            /*fromCache=*/ !0, t instanceof qn && t.Ye, e.m_);
    ...
    n.prototype.Cf = function(t) {
        ...
        return new aa(this.firestore, this.w_, e, t.fromCache, t.hasPendingWrites, this.m_);
    }, n;
}(Ru), ua = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (j("DocumentSnapshot.data", arguments, 0, 1), t = ba("DocumentSnapshot.data", t), 
        this.Nf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.m_) {
                var n = new ca(this.pf, this.w_, this.Nf, this.Ff, this.$f, 
                /* converter= */ null);
                return this.m_.fromFirestore(n, t);
            }
            return new ta(this.pf.d_, this.pf.yf(), t.serverTimestamps || "none", (function(t) {
                return new sa(t, e.pf, /* converter= */ null);
            }), (function(t) {
                return new dt(t);
            })).tf(this.Nf.sn());
        }
        ...
        var n = this;
        if (j("DocumentSnapshot.get", arguments, 1, 2), e = ba("DocumentSnapshot.get", e), 
        this.Nf) {
            var r = this.Nf.data().field(Ku("DocumentSnapshot.get", t, this.w_));
            if (null !== r) return new ta(this.pf.d_, this.pf.yf(), e.serverTimestamps || "none", (function(t) {
                return new sa(t, n.pf, n.m_);
            }), (function(t) {
                return new dt(t);
            })).tf(r);
        }
        ...
        get: function() {
            return new sa(this.w_, this.pf, this.m_);
        },
        enumerable: !1,
        configurable: !0
...
function ha(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || pa(s, o), 
    u = Gu(n, e, s, 
    /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
    var l = ur.create(i, o, u);
    return function(t, e) {
        if (e.un()) {
            var n = Hn(t);
...
function la(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!$n(e) && -1 !== n.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof Ru) return we(t, n.w_);
    throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + J(n) + ".");
}
...
var ya = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        G("Query.where", arguments, 3), Z("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = H("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = Ku("Query.where", e), s = ha(this.xf, "Query.where", this.firestore.Ef, this.firestore.d_, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new jn(t.path, t.collectionGroup, t.rn.slice(), n, t.limit, t.on, t.startAt, t.endAt);
        }(this.xf, s), this.firestore, this.m_);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (j("Query.orderBy", arguments, 1, 2), Q("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Ku("Query.orderBy", e), o = fa(this.xf, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.rn.concat([ e ]);
            return new jn(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.on, t.startAt, t.endAt);
        }(this.xf, o), this.firestore, this.m_);
    }, t.prototype.limit = function(e) {
        return G("Query.limit", arguments, 1), z("Query.limit", "number", 1, e), nt("Query.limit", 1, e), 
        new t(Zn(this.xf, e, "F" /* First */), this.firestore, this.m_);
    }, t.prototype.limitToLast = function(e) {
        return G("Query.limitToLast", arguments, 1), z("Query.limitToLast", "number", 1, e), 
        nt("Query.limitToLast", 1, e), new t(Zn(this.xf, e, "L" /* Last */), this.firestore, this.m_);
        ...
        /*before=*/ !0);
        return new t(er(this.xf, i), this.firestore, this.m_);
        ...
        return this.firestore === e.firestore && nr(this.xf, e.xf) && this.m_ === e.m_;
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.kf = function(t, e, n, i) {
        if (Z(t, 1, e), e instanceof aa) return G(t, r([ e ], n), 1), function(t, e, n, r, i) {
            ...
            for (var o = [], s = 0, u = Xn(t); s < u.length; s++) {
                var a = u[s];
                if (a.field.p()) o.push(we(e, r.key)); else {
                    var c = r.field(a.field);
                    if (ue(c)) throw new I(b.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.R();
        ...
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.p()) {
                    ...
                    if (!$n(t) && -1 !== c.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Zu(i[u]) || (tt("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else z("Query.onSnapshot", "function", u, i[u]), Q("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        Q("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new ma(r.firestore, r.xf, t, r.m_));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return va(this.xf), this.firestore._f().listen(this.xf, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        j("Query.get", arguments, 0, 1), Ia("Query.get", t), va(this.xf);
        var n = this.firestore._f();
        return (t && "cache" === t.source ? n.G_(this.xf) : n.z_(this.xf, t)).then((function(t) {
            return new ma(e.firestore, e.xf, t, e.m_);
        }));
    }, t;
}(), ma = /** @class */ function() {
    function t(t, e, n, r) {
        this.pf = t, this.Mf = e, this.Of = n, this.m_ = r, this.Lf = null, this.Bf = null, 
        this.metadata = new ua(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        j("QuerySnapshot.forEach", arguments, 1, 2), z("QuerySnapshot.forEach", "function", 1, t), 
        this.Of.docs.forEach((function(r) {
            t.call(e, n.qf(r, n.metadata.fromCache, n.Of.Qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new ya(this.Mf, this.pf, this.m_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (tt("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), W("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.pf === e.pf && nr(this.Mf, e.Mf) && this.Of.isEqual(e.Of) && this.m_ === e.m_;
    }, t.prototype.qf = function(t, e, n) {
        return new ca(this.pf, t.key, t, e, n, this.m_);
    }, t;
}(), ga = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Qn(t), n, r) || this).Uf = t, t.length % 2 != 1) throw new I(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.R() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.m() ? null : new sa(new F(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = V.P(t);
        return sa.gf(this.xf.path.child(e), this.firestore, this.m_);
    }, n.prototype.add = function(t) {
        G("CollectionReference.add", arguments, 1);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new sa(n.w_, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
...
function wa(t, e) {
    ...
    if (tt(t, e, [ "merge", "mergeFields" ]), W(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new I(b.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + J(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new I(b.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + J(r[o]));
        }(t, e, n, r, i);
...
function Ia(t, e) {
    Q(t, "object", 1, e), e && (tt(t, e, [ "source" ]), Y(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var Na = {
    ...
    Transaction: ia,
    WriteBatch: oa,
    DocumentReference: sa,
    DocumentSnapshot: aa,
    Query: ya,
    QueryDocumentSnapshot: ca,
    QuerySnapshot: ma,
    CollectionReference: ga,
    FieldPath: wu,
    FieldValue: Du,
    setLogLevel: ra.setLogLevel,
 ...
 */ function Aa(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new w("firestore", (function(t) {
            return function(t, e) {
                var n = new yu, r = new vu(n);
                return new ra(t, e, r, n);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Na)));
    }(t), t.registerVersion("@firebase/firestore", "1.17.1-2020822235757");
}

Aa(i);

export { Aa as __PRIVATE_registerFirestore };
